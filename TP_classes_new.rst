...
============================================
Dans un fichier nommé test_origine.py, créer une classe Point permettant de manipuler un point d'un axe, repéré par une abscisse. On devra pouvoir effectuer des changements d'origine, en conservant en permanence l'abscisse d'une origine courante (initialement 0). On prévoira simplement les méthodes suivantes :
...
Ecrire un petit programme de test qui utilise set_origine en tant que méthode de classe et qui fournit les résultats suivants::
    ...
    Point a
    abscisse = 3 relative à une origine d'abscisse absolue 0
    Point b 
    abscisse = 12 relative à une origine d'abscisse absolue 0
    On place l'origine en 3
    Point a
    abscisse = 0 relative à une origine d'abscisse absolue 3
    Point b
    abscisse = 9 relative à une origine d'abscisse absolue 3
